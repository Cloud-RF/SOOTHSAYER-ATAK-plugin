...
public class GLCloudRFLayer extends GLAbstractLayer {
    ...
    public final static GLLayerSpi2 SPI = new GLLayerSpi2() {
        ...
        public GLLayer2 create(Pair<MapRenderer, Layer> object) {
            if (!(object.second instanceof CloudRFLayer))
                return null;
            return new GLCloudRFLayer(object.first,
                    (CloudRFLayer) object.second);
        }
    };
    ...
    private Data frame;
    private final CloudRFLayer subject;

    public GLCloudRFLayer(MapRenderer surface, CloudRFLayer subject) {
